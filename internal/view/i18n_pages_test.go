...
var rawKeyPattern = regexp.MustCompile(`\b(servers|common|nav|home|diagnostics|login|bulk|terminal|files|system|error|module|pagination|shell|lang|drawer|commands)\.[a-z_]+(\.[a-z_]+)*\b`)
