...
var clientI18nKeys = []string{
	...
	"js.analytics.upload_scope",
	"js.analytics.total_scope",
	"js.analytics.period_range",
	...
	"js.tabs.fab_label",
	"js.tabs.load_failed",
	"js.tabs.load_failed_server",
	"js.tabs.load_failed_not_found",
	"js.tabs.load_failed_forbidden",
	"js.tabs.load_failed_status",
	"js.tabs.retry",
	"js.tabs.loading",
	"js.tabs.untitled",
