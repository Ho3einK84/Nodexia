...
func New(cfg config.Config) (*App, error) {
	...
	handler := apphttp.NewRouter(bootstrap.Config, bootstrap.Database, bootstrap.SSH, bootstrap.CommandStreams, bootstrap.TerminalTickets, bootstrap.LiveMetrics, bootstrap.Renderer, bootstrap.StaticFiles, bootstrap.Scheduler, bootstrap.Modules)
