...
running `make release VERSION=v0.7.3` (the existing `scripts/release.sh`)
already updates `scripts/install.sh`, `Makefile`, and the production compose
file. No new release automation was needed. See
